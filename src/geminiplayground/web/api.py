...
from geminiplayground.parts import GitRepoBranchNotFoundException
from geminiplayground.parts import MultimodalPartFactory
from geminiplayground.schemas import GenerationSettings
from geminiplayground.utils import create_image_thumbnail
from geminiplayground.utils import create_video_thumbnail
...
from geminiplayground.utils import get_repo_name
from googleapiclient.errors import HttpError
from sqlalchemy import select
from sqlalchemy.ext.asyncio import AsyncSession

from .db.models import EntryStatus
from .db.models import MultimodalPartEntry as MultimodalPartDBModel
    ...
    try:
        async for session in get_db_session():
            ...
            try:
                ...
                logger.info(
                    f"""Cloned repository {repo_name} from {
                ...
                logger.error(
                    f"""Error cloning repository {repo_name} from {
                        repo_path} branch {repo_branch}: {e}"""
                )
            finally:
